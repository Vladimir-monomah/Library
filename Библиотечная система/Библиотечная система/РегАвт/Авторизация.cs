...
using Библиотечная_система.Админка;
    ...
    public partial class Авторизация : Form
    {
        ...
        private void pictureBox2_Click(object sender, EventArgs e)
        {
            ...
            if (user != null)
            {
                ...
                {
                    Работа_внутри_БД открыть = new Работа_внутри_БД(user);
                    this.Hide();
                    открыть.Show();
                }
            }
        ...
        /// <returns></returns>
        private БиблиотекаDataSet.ПользователиRow FindUser(string login, string password)
        {
        ...
        private БиблиотекаDataSet.ПользователиRow User(string login)
        {
